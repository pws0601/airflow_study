...
with DAG(
    ...
    fetch_ratings = PythonOperator(
        ...
        templates_dict={
            "start_date": "{{ds}}",
            "end_date": "{{next_ds}}",
            "output_path": "/opt/airflow/dags/data/python/ratings/{{ds}}.json",
        },
    )
    ...
    rank_movies = PythonOperator(
        ...
        templates_dict={
            "input_path": "/opt/airflow/dags/data/python/ratings/{{ds}}.json",
            "output_path": "/opt/airflow/dags/data/python/rankings/{{ds}}.csv",
        },
    )
